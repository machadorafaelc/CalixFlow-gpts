...
import { Receipt, Palmtree } from 'lucide-react';
...
export function Sidebar({ currentView, onViewChange }: SidebarProps) {
  ...
  const menuItems = [
    { id: 'project-management', label: 'Gestão de Projetos', icon: Kanban, roles: ['super_admin', 'agency_admin', 'user'] },
    { id: 'gpts', label: 'GPTs Vega', icon: Bot, roles: ['super_admin', 'agency_admin', 'user'] },
    ...
    { id: 'ferias', label: 'Férias', icon: Palmtree, roles: ['super_admin', 'agency_admin', 'user'] },
    ...
    { id: 'gpt-debug', label: 'GPT Debug / Admin', icon: Settings, roles: ['super_admin'] },
